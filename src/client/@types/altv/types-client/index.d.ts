...
declare namespace AltVClient {
  ...
  export class LocalPlayer extends Player {
    ...
    public getMeta<K extends shared.ExtractStringKeys<ICustomLocalPlayerMeta>>(
      key: K,
    ): ICustomLocalPlayerMeta[K] | undefined;
    ...
    public setMeta<K extends shared.ExtractStringKeys<ICustomLocalPlayerMeta>>(
      key: K,
      value: ICustomLocalPlayerMeta[K],
    ): void;
    /** @deprecated See {@link ICustomLocalPlayerMeta} */
    public setMeta<V extends any, K extends string = string>(
      key: K,
   ...
   * @param args Rest parameters for emit to send.
   */
  export function emitServer<K extends keyof shared.ICustomClientServerEvent>(
    eventName: K,
    ...args: Parameters<shared.ICustomClientServerEvent[K]>
  ): void;
  export function emitServer<K extends string>(
   ...
   */
  export function emitServerRaw<K extends keyof shared.ICustomClientServerEvent>(
    eventName: K,
    ...args: Parameters<shared.ICustomClientServerEvent[K]>
  ): void;
  export function emitServerRaw<K extends string>(
    eventName: Exclude<K, keyof shared.ICustomClientServerEvent>,
    ...args: any[]
  ): void;
   ...
   *
   */
  export function emitServerUnreliable<K extends keyof shared.ICustomClientServerEvent>(
    eventName: K,
    ...args: Parameters<shared.ICustomClientServerEvent[K]>
  ): void;
  export function emitServerUnreliable<K extends string>(
    eventName: Exclude<K, keyof shared.ICustomClientServerEvent>,
    ...args: any[]
  ): void;
   ...
   *
   */
  export function emitRpc<K extends keyof shared.ICustomClientServerRpc>(
    rpcName: K,
    ...args: Parameters<shared.ICustomClientServerRpc[K]>
  ): Promise<ReturnType<shared.ICustomClientServerRpc[K]>>;
  export function emitRpc<K extends string>(
  ...
  export function onRpc<K extends keyof shared.ICustomServerClientRpc>(
    ...
    ) => Promise<ReturnType<shared.ICustomServerClientRpc[K]>> | ReturnType<shared.ICustomServerClientRpc[K]>,
  ): void;
   ...
   * @param listener Listener that should be removed.
   */
  export function offServer<K extends keyof shared.ICustomServerClientEvent>(
    eventName: K,
    listener: (...args: Parameters<shared.ICustomServerClientEvent[K]>) => void,
  ): void;
  export function offServer<K extends string>(
   ...
   * @param listener Listener that should be added.
   */
  export function on<K extends keyof IClientEvent | keyof ICustomEmitEvent>(
    eventName: K,
    listener: (...args: shared.EventParameters<IClientEvent, ICustomEmitEvent, K>) => void,
  ): void;
   ...
   * @param listener Listener that should be added.
   */
  export function once<K extends keyof IClientEvent | keyof ICustomEmitEvent>(
    eventName: K,
    listener: (...args: shared.EventParameters<IClientEvent, ICustomEmitEvent, K>) => void,
  ): void;
   ...
   * @param listener Listener that should be removed.
   */
  export function off<K extends keyof IClientEvent | keyof ICustomEmitEvent>(
    eventName: K,
    listener: (...args: shared.EventParameters<IClientEvent, ICustomEmitEvent, K>) => void,
  ): void;
   ...
   * @param listener Listener that should be added.
   */
  export function onServer<K extends keyof shared.ICustomServerClientEvent>(
    eventName: K,
    listener: (...args: Parameters<shared.ICustomServerClientEvent[K]>) => void,
  ): void;
  export function onServer<K extends string>(
    eventName: Exclude<K, keyof shared.ICustomServerClientEvent>,
    listener: (...args: any[]) => void,
  ): void;
   ...
   * @param listener Listener that should be added.
   */
  export function onceServer<K extends keyof shared.ICustomServerClientEvent>(
    eventName: K,
    listener: (...args: Parameters<shared.ICustomServerClientEvent[K]>) => void,
  ): void;
  export function onceServer<K extends string>(
    eventName: Exclude<K, keyof shared.ICustomServerClientEvent>,
    listener: (...args: any[]) => void,
  ): void;
   ...
   */
  export function setPedDlcClothes(
    scriptID: number,
    dlc: number,
    component: number,
    drawable: number,
  ...
  export function getLocalMeta<K extends shared.ExtractStringKeys<shared.ICustomPlayerLocalMeta>>(
    key: K,
  ...
  export class Ped extends Entity {
    ...
    public getSyncedMeta<K extends shared.ExtractStringKeys<shared.ICustomPedSyncedMeta>>(
      key: K,
    ...
    public getStreamSyncedMeta<K extends shared.ExtractStringKeys<shared.ICustomPedStreamSyncedMeta>>(
      key: K,
