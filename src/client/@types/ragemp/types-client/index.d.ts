...
declare interface CameraMp {
  ...
  setDofPlanes(
    nearOutOfFocusPlane: number,
    nearInFocusPlane: number,
    farInFocusPlane: number,
    farOutOfFocusPlane: number,
  ): void;
...
declare interface PedMpBase extends EntityMp {
  ...
  setAngledDefensiveArea(
    ...
    z2: number,
    fWidth: number,
    useCenterAsGoToPosition: boolean,
...
declare interface PlayerMp extends PedMpBase {
  ...
  setVoiceFxChorus(
    ...
    { fWetDryMix, fDepth, fFeedback, fFrequency, lWaveform, fDelay, lPhase }: VoiceFxChorus,
  ): void;
  setVoiceFxCompressor(
    fxHandle: VoiceHandle,
    { fGain, fAttack, fRelease, fThreshold, fRatio, fPredelay }: VoiceFxCompressor,
  ): void;
  ...
  setVoiceFxEcho(
    fxHandle: VoiceHandle,
    { fWetDryMix, fFeedback, fLeftDelay, fRightDelay, lPanDelay }: VoiceFxEcho,
  ): void;
  setVoiceFxFlanger(
    fxHandle: VoiceHandle,
    { fWetDryMix, fDepth, fFeedback, fFrequency, lWaveform, fDelay, lPhase }: VoiceFxFlanger,
  ): void;
