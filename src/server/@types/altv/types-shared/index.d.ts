...
declare namespace AltVShared {
  ...
  export class File {
    ...
    public static read(
      filename: string,
      encoding?: FileEncoding.Utf8 | `${FileEncoding.Utf8}` | FileEncoding.Utf16 | `${FileEncoding.Utf16}`,
    ): string;
  ...
  export class BaseObject {
    ...
    public getSyncedMeta<K extends ExtractStringKeys<ICustomBaseObjectSyncedMeta>>(
      key: K,
    ): ICustomBaseObjectSyncedMeta[K] | undefined;
  ...
  /** @deprecated See {@link ICustomGlobalMeta} */
  export function setMeta<V extends any, K extends string = string>(
    key: K,
  ...
  export function getSyncedMeta<K extends ExtractStringKeys<ICustomGlobalSyncedMeta>>(
    key: K,
  ): ICustomGlobalSyncedMeta[K] | undefined;
